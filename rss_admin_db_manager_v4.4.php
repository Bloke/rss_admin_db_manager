        ...
        if (preg_match("/^\\s*(insert|update|replace|delete|create|truncate) /i",$sql_query)) {
          ...
          if($run_query) $successquery++;
            if ($run_query && mysqli_num_rows($run_query) > 0) {
              ...
              while ($a = mysqli_fetch_assoc($run_query)) $out[] = $a;
...
You will also be alerted of any overhead or errors that need to be repaired.  Tables can be repaired, dropped or backed up from this listing.</p>
	...
	<ul>
		<li>Clicking on the name of the table will run a select * [table name] <span class="caps"><span class="caps">SQL</span></span> statement and take you to the <strong>Run <span class="caps"><span class="caps">SQL</span></span> tab</strong> to display the results.</li>
	...
	<h2>Run <span class="caps"><span class="caps">SQL</span></span> Window</h2>

	<p>The <strong>Run <span class="caps"><span class="caps">SQL</span></span> tab</strong> allows for free form entry and execution of <span class="caps"><span class="caps">SQL</span></span> statements.  The <span class="caps"><span class="caps">SQL</span></span> window accepts<br />

<span class="caps"><span class="caps">SELECT</span></span>, <span class="caps"><span class="caps">INSERT</span></span>, <span class="caps"><span class="caps">UPDATE</span></span>, <span class="caps"><span class="caps">CREATE</span></span>, <span class="caps"><span class="caps">REPLACE</span></span>, <span class="caps"><span class="caps">TRUNCATE</span></span>, and <span class="caps"><span class="caps">DELETE</span></span> statements.  If a <span class="caps"><span class="caps">SELECT</span></span> statement is run, the results will be displayed to you below the <span class="caps"><span class="caps">SQL</span></span> window in a table.<br />

The table markup allows you to add your own styles for creating a <a href="http://www.agavegroup.com/?p=31"><span class="caps"><span class="caps">CSS</span></span> Scrollable Table</a>.</p>
